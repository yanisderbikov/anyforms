...
public enum AmoLeadStatus {
    ...
    /**
     * Доставлен - заказ доставлен и его можно забрать
     */
    DELIVERED(78794054L, "Доставлен"),

    /**
     * Реализовано - заказ получен клиентом
     */
    REALIZED(142L, "Реализовано"),

    /**
     * Реализовано - заказ получен клиентом
     */
    NOT_REALIZED(142L, "Не реализовано"),
